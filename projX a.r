...
write.xlsx(get_peaks_af_we, "fst_af_we_peaks_dataframe_nc.xlsx")
...
write.xlsx(get_peaks_we_ea, "fst_we_ea_peaks_dataframe_nc.xlsx")
...
write.xlsx(get_peaks_ea_af, "fst_ea_af_peaks_dataframe_nc.xlsx")
